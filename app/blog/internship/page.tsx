		...
		<div className={styles.page}>
			<div className={styles.container}>
				...
				<article className={styles.article}>
					<p>
						For my internship I joined the OutKept team in
						Ghent as a full-stack developer. OutKept is a
						cybersecurity awareness company based in Ghent
						that runs an automated phishing simulation
						platform. Rather than using generic email
						templates, they crowdsource realistic phishing
						simulations from a community of ethical phishers
						(who can earn money doing this).
					</p>
					...
					<section className={styles.section}>
						...
						<p>
							...
							to work on the platform of OutKept,
							contributing to both frontend and backend
							development. In the beginning I received a
							lot of small UI/UX bugs to fix, which was a
							great way to get familiar with the codebase
							and the product, from the client, phisher and
							manager side. As I got more comfortable, I
							started taking on larger features and
							improvements, working closely with the team
					...
					<section className={styles.section}>
						...
						<ul className={styles.list}>
							<li>
								...
								has in the cybersecurity space.
							</li>
							<li>
								<strong>Internal Hackathon</strong> - In
								the middle of my internship, the team
								organized an internal hackathon focused
								on outreach in different countries. We
								had to come up with creative ways to
								spread awareness about cybersecurity and
								phishing. It was a fun and learning
								experience with the use of AI and
								outreach tools like Lemlist, and it was
								great to see the team come together to
								brainstorm and execute on different
								ideas.
							</li>
							<li>
								<strong>Cybersec Europe 2026</strong> -
								In my last days of my internship, I had
								the opportunity to attend 2 days of the
								Cybersec Europe conference in Brussels
								Expo with the team. It was a great
								chance to learn about the latest trends
								and developments in cybersecurity with
							...
							<li>
								...
								know the people who work their.
							</li>
						</ul>
					</section>
					...
					<section className={styles.section}>
						...
						<p>
							The internship gave me a great opportunity to
							apply and deepen my technical skills in a
							real-world setting. I got hands-on experience
							with technologies and I learned how to
							navigate the complexities of working on a
							production codebase. I also gained insights
							into the importance of ui/ux design (how to
							think about what a simple user would expect
							from a feature, and how to design for that).
							Overall, it was a valuable experience that
							helped me grow as a developer and gave me a
